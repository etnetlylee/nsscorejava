...
import coreConfigInterface.InitiatorConfig;
import coreConfigInterface.ServerUrls;

public class UsConfigStressTestConfig {
    public final CoreConfig HkConfig = new CoreConfig(
            "H5", // productName
            "TC", // lang:TC|SC|EN
            new ServerUrls(
                    "http://10.1.8.134:1444/websocket", // wss -> StressTest ServerURL
            ...
            new HashMap<String, String>() {{
                ...
                put("WSIP", EndPoints.ENDPOINT_WSIP_US_COMPOSITE); // TODO: hard coded
