...
import com.etnet.coresdk.model.IEInfoStruct;
import com.etnet.coresdk.model.IndexBaseInfo;
import com.etnet.coresdk.model.Industry;
import com.etnet.coresdk.model.IndustryBaseInfo;
import com.etnet.coresdk.model.IndustryInfo;
...
public class AsaStorage {
    ...
    // Decoder5
    public List<BrokerFirm> GROBROKER = new ArrayList<BrokerFirm>();
    ...
    public Map<String, String> CBBC_RN_MAP = new HashMap<String, String>(); // underlying code => bull bear type
    public List<String> ADR_LIST = new ArrayList<String>(); // ADR code list
    // TRADING_TIME_MAP: {} = {};
    // TRADING_DAY_LIST: any[] = [];
    // AHFT_VALUE_MAP: {} = {};
    public Map<String, List<String>> FUTURE_MONTH_MAP_FROM_ASA = new HashMap<String, List<String>>(); // futureCode =>
    // monthlist
    public Map<String, String> FUTURE_UNDERLYING_MAP_FROM_ASA = new HashMap<String, String>(); // code =>
    public Map<String, String> OPTION_UNDERLYING_MAP_FROM_ASA = new HashMap<String, String>(); // code =>
    public Map<String, String> DECI_MAP_FROM_ASA = new HashMap<String, String>(); // code =>
    public Map<String, String> DECI_MAP_FROM_ASA_OPTION = new HashMap<String, String>(); // code =>
    public Map<String, String> DECI_MAP_FROM_ASA_FUTURE = new HashMap<String, String>(); // code =>
    public Map<String, List<IndexBaseInfo>> INDEX_BASE_INFO_MAP = new HashMap<String, List<IndexBaseInfo>>(); // screenName
    // => indexbaseinfo list
    // Decoder11
    public List<String> INDUSTRY_SC_LIST = new ArrayList<String>();
    public List<String> INDUSTRY_TC_LIST = new ArrayList<String>();
    public List<String> INDUSTRY_EN_LIST = new ArrayList<String>();
    public List<String> INDUSTRY_LIST = new ArrayList<String>();
    public List<IndustryBaseInfo> INDUSTRY_CODE_LIST = new ArrayList<IndustryBaseInfo>();
    public Map<String, List<String>> INDUSTRY_CODES_MAP = new HashMap<String, List<String>>(); // industryCode => list
    public Map<String, String> INDUSTRY_CODE_MAP = new HashMap<String, String>(); // code => industry code
    // STOCK_INFO_MAP: { [code: string]: StockInfo } = {};
    public Map<String, IndustryInfo> INDUSTRY_MAP = new HashMap<String, IndustryInfo>(); // industryCode => IndustryInfo
    // Decoder12
    public double BLOCKTRADE = Double.NaN;
    public double BLOCKTRADENUM;
    public double BLOCKTRADENUM_EX;
    // Decoder13
    ...
    // Decoder17
    public List<Integer> TRADING_DAY_LIST = new ArrayList<Integer>();
    // Decoder18
    public Map<String, Map<String, TradingTimeInfo>> TRADING_TIME_MAP =
            new HashMap<String, Map<String, TradingTimeInfo>>(); // typeKey => {code: TradingTimeInfo}
    public String STOCK_DEF_CUTOFF = "1230";
    // Decoder19
    ...
    // Deocder24
    public String ShortSellDate;
    // Decoder25
    public Map<String, String> TIPS_NAME_MAP = new HashMap<String, String>(); // tipsId(authorId) => tipsName(auther name)
    // Decoder29
    public Map<String, List<String>> ISSUMAP = new HashMap<String, List<String>>(); // lang => issuers

    // Decoder31
    Map<String, IEInfoStruct> URL_INFO_MAP = new HashMap<String, IEInfoStruct>(); // key => IEInfo

    // Decoder38
    public Map<String, List<String>> OPTION_MONTH_MAP_FROM_ASA = new HashMap<String, List<String>>(); // code => monthlist
    ...
    // Decoder37
    // Decoder39
    public Map<String, String> AHFT_MAP = new HashMap<String, String>(); // main code => underlying code
    public Map<String, String> AHFT_VALUE_MAP = new HashMap<String, String>(); // underlying code => main code
    // Decoder40
    public Map<String, String> DTDC_MAP = new HashMap<String, String>(); // a share code => hkex code
    public Map<String, String> DTDC_VALUE_MAP = new HashMap<String, String>(); // hkex code => ashare code
    public List<String> DTDC_LIST = new ArrayList<String>(); // A-Share codes

    // Decoder42
    public Map DECI_RELATED_MAP_FROM_ASA = new HashMap<>();

    // Decoder60
    public List<String> SH_SHARE_LIST = new ArrayList<String>();
    // VALIDCODE: string[] = [];
    // SEC_TYPE_STOCK
    public List<StockInfo> SH_SHARE_INFO_LIST = new ArrayList<StockInfo>();
    public Map<String, StockInfo> SH_SHARE_STOCK_INFO_MAP = new HashMap<String, StockInfo>(); // shCode => Stockinfo
    Map SEC_TYPE_STOCK = new HashMap<>();

    // Decoder61
    public List<Object> SH_SHARE_CONSTATE_HLIST = new ArrayList<Object>();
    public List<Object> SH_SHARE_CONSTATE_ALIST = new ArrayList<Object>();

    // Decoder63
    public List<String> SH_SHARE_INDUSTRY_LIST = new ArrayList<String>();
    public List<Industry> SH_SHARE_INDUSTRY_CODE_INFO_LIST = new ArrayList<Industry>();
    public Map SH_SHARE_CODE_INDUSTRY_MAP = new HashMap<>();
    public Map SH_SHARE_NUMBER_FOR_INDUSTRY_MAP = new HashMap<>();
    public Map SH_SHARE_INDUSTRY_CODES_MAP = new HashMap<>();
    public Map<String, Industry> SH_SHARE_CODE_INDUSTRYINFO_MAP = new HashMap<>(); // indCode => Industry
    public Map<String, Boolean> SH_SHARE_CONNECT_STATES_MAP = new HashMap<String, Boolean>(); // code => state

    // Decoder65
    public List<Integer> ASHARE_SH_TRADINGDAY_LIST = new ArrayList<Integer>();

    // Decoder70
    public List<String> SZ_SHARE_LIST = new ArrayList<String>();
    // VALIDCODE: string[] = [];
    // SEC_TYPE_STOCK
    public List<StockInfo> SZ_SHARE_INFO_LIST = new ArrayList<StockInfo>();
    public Map<String, StockInfo> SZ_SHARE_STOCK_INFO_MAP = new HashMap<String, StockInfo>(); // szCode => StockInfo

    // Decoder71
    // todo
    public List<String> SZ_SHARE_CONSTATE_HLIST = new ArrayList<String>();
    public List<String> SZ_SHARE_CONSTATE_ALIST = new ArrayList<String>();
    public Map<String, Boolean> SZ_SHARE_CONNECT_STATES_MAP = new HashMap<String, Boolean>(); // aCode => state
    // Decoder73
    public List<String> SZ_SHARE_INDUSTRY_LIST = new ArrayList<String>();
    public List<Industry> SZ_SHARE_INDUSTRY_CODE_INFO_LIST = new ArrayList<Industry>();
    public Map<String, String> SZ_SHARE_CODE_INDUSTRY_MAP = new HashMap<String, String>(); // code => industry code
    public Map<String, Integer> SZ_SHARE_NUMBER_FOR_INDUSTRY_MAP = new HashMap<String, Integer>(); // indCode => num
    public Map<String, List<String>> SZ_SHARE_INDUSTRY_CODES_MAP = new HashMap<String, List<String>>(); // indeCode => list
    public Map<String, Industry> SZ_SHARE_CODE_INDUSTRYINFO_MAP = new HashMap<String, Industry>(); // indCode => Industry

    // Decoder83

    // Decoder75
    public List<Integer> ASHARE_SZ_TRADINGDAY_LIST = new ArrayList<Integer>();

    // Decoder85
    public Map<String, List<String>> HSHARE_COMMENTATOR_LIST = new HashMap<String, List<String>>(); // lang => list
    public Map<String, List<String>> HSHARE_RECOMMENTATOR_LIST = new HashMap<String, List<String>>(); // lang => list
    public List<FirmName> FIRM_NAME = new ArrayList<FirmName>();

    // Decoder88
    public List<Integer> TRADING_DAY_LIST_20 = new ArrayList<Integer>();
    ...
    // Decoder89US
    public List<Object> US_INDEX_LIST = new ArrayList<Object>();

    // Decoder90US
    public List<Object> US_INDUSTRY_CODE_LIST = new ArrayList<Object>();

    //
    public List<Object> RISK_FREE_VALUE = new ArrayList<Object>();

    // DecoderStaticResource
    Map<String, Object> STATIC_RESOURCE = new HashMap<String, Object>();
    public Map<String, List<InstrumentInfo>> INSTRUMENT_NAME = new HashMap<String, List<InstrumentInfo>>(); // securityType
    // => InstrumentInfo list
    public Map<String, List<SearchListItem>> SEARCH_LIST = new HashMap<String, List<SearchListItem>>(); // listName =>
    // SearchListItemList
