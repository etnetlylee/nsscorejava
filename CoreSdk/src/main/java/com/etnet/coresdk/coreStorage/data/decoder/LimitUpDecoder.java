...
import com.etnet.coresdk.coreStorage.model.LimitUpdownStruct;

public class LimitUpDecoder extends Decoder {
    public static final String uniqueID = "limitup";
