...
import static com.etnet.coresdk.constants.AsaConstant.STOCK_CONNECTED_CURRENT;
import static com.etnet.coresdk.constants.AsaConstant.STOCK_CONNECTED_EX;
import static com.etnet.coresdk.constants.AsaConstant.STOCK_EXCHANGE_HKEXSZ;
import static com.etnet.coresdk.constants.AsaConstant.STOCK_EXCHANGE_SZSE;

public class Decoder71 extends Decoder {
    public static final String uniqueID = "71";
